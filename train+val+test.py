...
dir_img ='/home/syx/US_kidney/SUGH/png_mini_mini_arg/slice'#'/home/syx/US_kidney/SZRH/train&val/slice_arg'## '/home/syx/kits19-master/png_datasize/style_transfer/GAN_test15/slice/images' #
dir_mask ='/home/syx/US_kidney/SUGH/png_mini_mini_arg/mask'#'/home/syx/US_kidney/SZRH/train&val/mask_arg'#   '/home/syx/kits19-master/png_datasize/style_transfer/GAN_test15/mask'  #
dir_checkpoint = 'checkpoints/U-net_our/'
# test_img='/home/syx/US_kidney/SUGH/test/slice'#'/home/syx/US_kidney/SZRH/test/slice_png'
# test_mask='/home/syx/US_kidney/SUGH/test/mask'#'/home/syx/US_kidney/SZRH/test/mask_png'
cross_img='/home/syx/US_kidney/SZRH/test/slice_png'#'/home/syx/US_kidney/SZRH/train&val/slice_arg'#'/home/syx/US_kidney/SUGH/png_mini_mini/slice'
cross_mask='/home/syx/US_kidney/SZRH/test/mask_png'#'/home/syx/US_kidney/SZRH/train&val/mask_arg'#'/home/syx/US_kidney/SUGH/png_mini_mini/mask'
...
def train_net(net,
    ...
    sugh_loader = DataLoader(cross, batch_size=batch_size, shuffle=False, num_workers=8, pin_memory=True, drop_last=True)
    ...
    for epoch in range(epochs):
        ...
        with tqdm(total=n_train, desc=f'Epoch {epoch + 1}/{epochs}', unit='img') as pbar:
            for batch in train_loader:
                ...
                if global_step % (n_train // (0.5* batch_size)) == 0:
...
if __name__ == '__main__':
    ...
    # net=
    # #logging.info(f'Network:\n'simCT6000_batch=8_fcn_scale=0.5_epoch=18_transnature
